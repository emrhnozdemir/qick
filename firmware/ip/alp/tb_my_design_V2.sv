...
module tb_my_design_wrapper();
    ...
    initial begin
        ...
        qtag_dt4_i = 32'd1000000;   // First Sweep Step (NEW)
        
        @(posedge clk); #1;
        qtag_en_i  = 1'b0;
        $display("[%0t] CONFIG 0 SENT: Start=6000000, Stop=30000000, Avg=3, Step1=1000000", $time);
        #50;
        ...
        qtag_en_i  = 1'b1;
        qtag_op_i  = 5'd3;
        qtag_dt1_i = 32'd0;         // Unused in wrapper
        qtag_dt2_i = 32'd100000;    // Second Sweep Step (NEW)
        qtag_dt3_i = 32'd5000000;   // Second Sweep Window (NEW)
        qtag_dt4_i = 32'd0;         // Unused
        
        @(posedge clk); #1;
        qtag_en_i  = 1'b0;
        $display("[%0t] CONFIG 3 SENT: Step2=100000, Window=5000000", $time);
        #50;
