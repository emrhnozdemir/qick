...
module estop_ckdiff (
  ...
  input wire signed [63:0] p_i_i,
  input wire signed [63:0] p_q_i,
  ...
  wire signed [63:0] cd_i = s_i_i - (p_i_i <<< 1);
  wire signed [63:0] cd_q = s_q_i - (p_q_i <<< 1);
